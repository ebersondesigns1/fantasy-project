...
<footer class="{!outOfDate ? '' : 'invisible'}" bind:this={el}>
	...
	<!-- PLEASE DO NOT REMOVE THE COPYRIGHT -->
	<span class="copyright">&copy; 2021 - {year} <a href="https://github.com/ebersondesigns1">The Blitz League Page</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by <a href="http://www.ebersondesigns.com">Eberson Designs</a><br /></span>
</footer>
